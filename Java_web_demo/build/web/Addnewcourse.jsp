                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="content">
                                        <div id="page-inner"> 
                                            <form action="ControllerCourse?ac=add" method="POST"  >
                                                <table>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="txttopic" required=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label for="uname"><b>Start</label> </td>
                                                        <td><input type="text" name="txtstart" required="" ></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label for="uname"><b>End</label> </td>
                                                        <td><input type="text" name="txtend" required="" ></td>
                                                    </tr>

                                                    <tr>

                                                        <td colspan="2" align="center"><button  class="add1" type="submit" onclick="addsi()">Add new   <i class="fa fa-plus-circle"></i>  </button></td>
